...
async function main() {
  console.log("🧪 Testing Simple Q&A Contract Functionality (Basic Version)...");
  ...
  // Test 6: Get question details before approval
  console.log("\n❓ Question Details (Before Approval):");
  ...
  // Test 7: Get user stats before approval
  console.log("\n👤 User 2 Stats (Before Approval):");
  ...
  console.log("   • All data retrieval functions work");
  console.log("   • User reputation is tracked");
  console.log("\n⚠️  Note: VeBetterDAO integration requires real contract addresses");
  console.log("   For full functionality, deploy to VeChain testnet with real VeBetterDAO addresses");
}
